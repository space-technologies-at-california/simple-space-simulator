...
magnetorquer_x = CubeSpaceMediumRod(position=(0, 0, 0), orientation=(0, 0, 0), id='mx', max_voltage=5)
magnetorquer_y = CubeSpaceMediumRod(position=(0, 0, 0), orientation=(0, 0, np.pi / 2), id='my', max_voltage=5)
magnetorquer_z = CubeSpaceMediumRod(position=(0, 0, 0), orientation=(0, -np.pi / 2, 0), id='mz', max_voltage=5)
...
controller = ScheduledController(gains=np.array([6.3, 6.3, 6.3]),
